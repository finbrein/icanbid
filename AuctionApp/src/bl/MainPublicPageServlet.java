...
public class MainPublicPageServlet extends HttpServlet {
	...
	throws ServletException, java.io.IOException {
		...
		out.println("<!--This is the Main Public Page HTML form -->");
		out.println("<html>");
		out.println("<head>");
		...
		out.println("<td><a href='http://app.cc.puv.fi/icanbid/LoginForm.jsp'>Log In</a><span class='link-delimiter'> | </span></td>");
		out.println("<td><a href='#'>Account</a><span class='link-delimiter'> | </span></td>");
		out.println("<td><a href='http://app.cc.puv.fi/icanbid/RegistrationForm.jsp'>Register</a><span class='link-delimiter'> | </span></td>");
		out.println("<td><a href='#'>About iCANBID</a></td>");			
		out.println("</tr>");
		out.println("</table>");		
		out.println("</div>");
		...
		try {
			...
			out.println("<th align='left'>Product</th>");
			out.println("<th align='left'>Price</th>");
			out.println("<th align='left'>Amount</th>");
			out.println("<th align='center'>Image</th>");
			out.println("</tr>");
