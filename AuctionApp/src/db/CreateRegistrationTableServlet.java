...
public class CreateRegistrationTableServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String table1 = "Registration";
		
		String createRegistration;

		createRegistration = "Create table " + table1 + " (USERNAME VARCHAR(20), PASSWORD VARCHAR(20), " +
												"EMAIL VARCHAR(20), FIRSTNAME VARCHAR(20),LASTNAME VARCHAR(20))";
		...
		try {
			...
			stmt.executeUpdate(createRegistration);
