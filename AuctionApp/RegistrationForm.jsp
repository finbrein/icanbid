...
<!-- Minimum width: 900 pixels --> 
		...
		<div id="hinav" class="title-section">
			...
			<ul class="a">
			<li class="top"><a href="http://app.cc.puv.fi/icanbid/index.jsp" class="parent">HOME</a><hr/></li>
			<li class="middle">
			<strong>
				<a class="middle" href="http://app.cc.puv.fi/icanbid/RegistrationForm.jsp">iCANBID Registration</a>
			</strong><hr/></li>
			<li class="bottom">
						...
						<table border="0" style="width: 80%" class="tableLoginInfo" cellspacing="8px"> 
							...
							<td colspan="3" width="30%" class="logintableHeaderContent"><strong>Login Information<hr/></strong></td> 
								...
								<tbody> 
										...
										<td valign="top"> 
										<input type="text" name="repeatEmailAddress" value="" size="33" maxlength="50"> 
										</td> 
										<td valign="top"></td> 
										</tr> 
										<tr> 
								...
								<table border="0" style="width:100%" class="otherInfo" cellspacing="8px"> 
									<tr> 
										<td valign="top" colspan="3"> 			  
											...
											<a href="http://app.cc.puv.fi/icanbid/index.jsp" name="Cancel"><strong>Cancel</strong></a> 
											<br/> 
											<p>If you have questions or need further assistance, please email <a href= "http://app.cc.puv.fi/icanbid/RegistrationForm.jsp">web-help@icanbid.com</a>.</p> 
